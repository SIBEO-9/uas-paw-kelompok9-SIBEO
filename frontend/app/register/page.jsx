...
export default function RegisterPage() {
  ...
  const validateForm = () => {
    ...
    if (role === "instructor") {
      if (!otpCode) {
        newErrors.otp = "Kode verifikasi wajib diisi untuk instruktur"
        setOtpError("Kode verifikasi wajib diisi")
      } else if (otpCode !== "292929") {
        newErrors.otp = "Kode verifikasi salah"
  ...
  const handleContactAdmin = () => {
    const message = encodeURIComponent(
      `Halo Admin SIBEO, saya ${name || "[Nama Lengkap]"} ingin mendaftar sebagai Instruktur. Mohon informasinya untuk kode verifikasi.`,
    )
                ...
                <div className="space-y-3">
                  <Alert className="bg-primary/5 border-primary/20">
                    ...
                    <AlertDescription className="text-sm">
                      Pendaftaran instruktur memerlukan verifikasi admin. Hubungi admin untuk mendapatkan kode
                      verifikasi.
                    </AlertDescription>
                  </Alert>
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="otpCode">Kode OTP Instruktur</Label>
                    <Input
                      id="otpCode"
