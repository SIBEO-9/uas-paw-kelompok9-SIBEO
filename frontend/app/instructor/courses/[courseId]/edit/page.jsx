...
export default function EditCoursePage() {
  ...
  const loadCourseData = async () => {
    try {
      setLoading(true)
      const response = await courseService.getCourseById(params.courseId) // Updated to use courseId
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await courseService.updateCourse(params.courseId, formData) // Updated to use courseId
      alert("Kursus berhasil diupdate!")
      router.push(`/instructor/courses/${params.courseId}`) // Updated to use courseId
    } catch (error) {
