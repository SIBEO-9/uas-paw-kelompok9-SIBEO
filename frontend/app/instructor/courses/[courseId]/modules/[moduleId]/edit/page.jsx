...
import { courseService, moduleService } from "@/lib/api"
...
export default function EditModulePage() {
  ...
  useEffect(() => {
    loadModuleData()
  }, [params.moduleId]) // Updated to use moduleId

  const loadModuleData = async () => {
    try {
      setLoading(true)
      const modulesRes = await courseService.getModules(params.courseId)
      const module = modulesRes.data.find((m) => m.id === Number.parseInt(params.moduleId)) // Updated to use moduleId
      ...
      if (module) {
        setFormData({
          ...
          duration: module.duration ? module.duration.toString() : "",
        })
      }
    } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await moduleService.updateModule(params.moduleId, {
        // Updated to use moduleId
        ...formData,
      ...
      alert("Gagal mengupdate modul: " + error.message)
    } finally {
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Perbarui konten modul menggunakan Markdown. Anda bisa menambahkan link, gambar, dan format teks.
              </CardDescription>
            </CardHeader>
            <CardContent>
