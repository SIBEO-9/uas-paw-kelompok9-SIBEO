  ...
  const features = [
    {
      ...
      description: "Akses berbagai kursus dari instruktur berpengalaman",
    },
    {
      icon: Users,
      title: "Komunitas Aktif",
      description: "Belajar bersama ribuan mahasiswa lainnya",
    },
    {
      icon: Award,
      title: "Sertifikat",
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg md:text-xl text-muted-foreground mb-8 text-pretty leading-relaxed">
                Platform e-learning terpadu untuk mahasiswa dan instruktur. Mulai perjalanan belajar Anda hari ini.
              </p>
        ...
        <section className="py-16 md:py-24 bg-black text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-gray-400 mb-8 max-w-2xl mx-auto">
              Bergabung dengan ribuan mahasiswa yang telah memulai perjalanan belajar mereka
            </p>
            <Link href="/register">
