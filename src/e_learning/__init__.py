...
# ==============================================
# MONKEY PATCH CRITICAL FOR PYTHON 3.13 COMPATIBILITY
# WebOb 1.8.7 still imports cgi.parse_header which was removed in Python 3.13
# This patch MUST be at the VERY BEGINNING of the file, BEFORE any other imports
# ==============================================

if sys.version_info >= (3, 13):
    # Create a fake cgi module to prevent ModuleNotFoundError
    cgi_module = types.ModuleType('cgi')
    
    def parse_header(line):
        """
        Minimal implementation of cgi.parse_header for WebOb compatibility.
        WebOb expects this function to parse Content-Type headers.
        """
        if not line:
            return '', {}
    ...
    # Inject into sys.modules BEFORE WebOb tries to import it
